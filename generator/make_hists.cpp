...
int main(int argc, char ** argv)
{
	...
	h1p_list.push_back(h1p_mom1);
        TH1D * h1p_alphaq = new TH1D("ep_alphaq","ep;alphaq;Counts",40,-2,0);
        h1p_list.push_back(h1p_alphaq);
        TH1D * h1p_alphaLead = new TH1D("ep_alphaLead","ep;alphaLead;Counts",40,0,1);
        h1p_list.push_back(h1p_alphaLead);
        TH1D * h1p_alphaM = new TH1D("ep_alphaM","ep;alphaM;Counts",40,1,2);
	...
	TH1D * h2p_alphaq = new TH1D("epp_alphaq","ep;alphaq;Counts",40,-2,0);
        h2p_list.push_back(h2p_alphaq);
        TH1D * h2p_alphaLead = new TH1D("epp_alphaLead","ep;alphaLead;Counts",40,0,1);
        h2p_list.push_back(h2p_alphaLead);
        TH1D * h2p_alphaM = new TH1D("epp_alphaM","ep;alphaM;Counts",40,1,2);
        h2p_list.push_back(h2p_alphaM);
        TH1D * h2p_alphaRec = new TH1D("epp_alphaRec","ep;alphaRec;Counts",40,0,1.5);
        h2p_list.push_back(h2p_alphaRec);
        TH1D * h2p_alphaD = new TH1D("epp_alphaD","ep;alphaD;Counts",40,1.5,3);
