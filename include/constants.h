...
const double coarse_bin_edges_v2[10]={0.4,0.45,0.5,0.55,0.6,0.65,0.7,0.75,0.875,0.95};
const double coarse_bin_edges_new[10]={0.4,0.44,0.48,0.52,0.58,0.64,0.7,0.78,0.88,1.0};
